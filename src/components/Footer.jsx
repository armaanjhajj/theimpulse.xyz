...
export default function Footer() {
  return (
    <footer className="relative bg-black text-white py-16 md:py-24">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="text-right">
            ...
            >
              {/* Twitter */}
              <a href="#" className="w-8 h-8 border border-white rounded-full flex items-center justify-center hover:bg-white hover:text-black transition-colors">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center md:justify-start space-x-6 mb-4 md:mb-0">
            ...
            <a href="/terms-of-use.html" className="text-gray-300 hover:text-white transition-colors">
              Terms of Use
            </a>
          </div>
