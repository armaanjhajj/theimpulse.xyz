...
export default function NewSplineItem() {
    ...
    return (
      <div className="w-full h-96 md:h-[500px] relative flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <div className="text-xl text-gray-600">New Spline Item</div>
  ...
  return (
    <div className="w-full h-96 md:h-[500px] relative">
      <Spline
        scene="https://prod.spline.design/gSdC6S5UJmGusOSc/scene.splinecode"
      />
    </div>
  );
}
